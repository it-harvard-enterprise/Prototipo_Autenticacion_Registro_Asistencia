...
func main() {
	...
	router.GET("/api/grades/periods", handlers.GetAcademicPeriodsHandler(app))
	router.POST("/api/grades/periods", handlers.CreateAcademicPeriodHandler(app))
	router.GET("/api/grades/roster", handlers.GetGradesRosterHandler(app))
	router.POST("/api/grades/save", handlers.SaveGradesHandler(app))
	router.POST("/api/grades/professor-signature", handlers.UpdateProfessorSignatureHandler(app))
	router.GET("/api/grades/report", handlers.DownloadGradeReportHandler(app))
