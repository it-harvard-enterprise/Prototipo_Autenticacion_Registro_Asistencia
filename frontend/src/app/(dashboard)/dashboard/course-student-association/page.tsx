...
export default function CourseStudentAssociationPage() {
  ...
  async function onSubmit(values: AssociationFormValues) {
    ...
    const result = await associateStudentsToCourse(Number(values.idCurso), ids);
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Ingrese uno o varios números de identificación de estudiantes
            (separados por comas si son más de 1) y un ID de curso válido.
          </p>
        </div>
      </div>
      ...
      <Card className="max-w-4xl">
        <CardHeader>
          ...
          <CardDescription>
            Esta operación inserta registros en la tabla cursos_x_estudiantes.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ej: 1001,1002,1003" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="rounded-md border border-gray-200 p-3 bg-gray-50">
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-semibold">{studentIds.length}</span>
                </p>
